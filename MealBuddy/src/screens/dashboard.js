...
return (
  <View style={styles.container}>
    ...
    <View style={styles.largeTrackerRow}>
      <CircularTracker label="Calories" value={totals.calories} maxValue={2000} color={Colors.calories} size={140} unit="kcal" />
      <CircularTracker label="Water Intake" value={totals.water} maxValue={3000} color={Colors.water} size={140} unit="ml" />
    </View>

    <View style={styles.smallTrackerRow}>
      <CircularTracker label="Protein" value={totals.protein} maxValue={100} color={Colors.protein} size={100} unit="g" />
      <CircularTracker label="Sugar" value={totals.sugar} maxValue={250} color={Colors.carbs} size={100} unit="g" />
      <CircularTracker label="Fats" value={totals.fats} maxValue={70} color={Colors.fats} size={100} unit="g" />
    </View>
