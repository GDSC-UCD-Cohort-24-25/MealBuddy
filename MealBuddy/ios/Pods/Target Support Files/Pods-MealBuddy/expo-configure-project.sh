...
with_node \
  ...
  --target "/Users/dariusehsani/Documents/GDSC/MealBuddy/MealBuddy/ios/Pods/Target Support Files/Pods-MealBuddy/ExpoModulesProvider.swift" \
  --entitlement "/Users/dariusehsani/Documents/GDSC/MealBuddy/MealBuddy/ios/MealBuddy/MealBuddy.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
